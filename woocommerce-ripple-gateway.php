    ...
    class WcLitecoin
    {
	    ...
	    public function convertToXrp($price_string, $price)
	    {
	        ...
	        if ($options['show_prices'] == 'yes') {
	            ...
	            if ($xrp_price) {
	                $new_price_string = $price_string . '&nbsp;(<span class="woocommerce-price-amount amount">' . $ltc_price . '&nbsp;</span><span class="woocommerce-price-currencySymbol">XPR)</span>';
